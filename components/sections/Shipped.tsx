        ...
        <div className="mt-20 grid gap-8 md:grid-cols-2">
          {projects.map((project) => (
            <DecoCard key={project.title}>
              <header className="flex items-start justify-between gap-6 border-b border-[color:var(--color-gold)]/20 pb-6">
                <div>
                  ...
                  <p className="mt-2 font-body text-sm text-[color:var(--color-fg)]/80">
                    {project.org}
                  </p>
                </div>
              ...
              <div className="mt-8 flex flex-wrap gap-2">
                {project.stack.map((tech) => (
                  <span
                    key={tech}
                    className="border border-[color:var(--color-gold)]/50 px-3 py-1 font-body text-[10px] uppercase tracking-[0.25em] text-[color:var(--color-gold)]"
                  >
                    {tech}
                  </span>
                ))}
